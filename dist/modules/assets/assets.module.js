...
const gcp_storage_module_1 = require("../../infra/gcp/gcp-storage.module");
...
exports.AssetsModule = AssetsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: asset_s3_object_schema_1.AssetS3Object.name, schema: asset_s3_object_schema_1.AssetS3ObjectSchema }]),
            gcp_storage_module_1.GcpStorageModule,
