...
export class AdminAuthService {
  ...
  async login(loginDto: AdminLoginDto): Promise<{
    ...
    console.log("Attempting admin login for email:", normalizedEmail, password);
    ...
    // find hardcoded admin
    const admin = ADMIN_ACCOUNTS.find((a) => a.email === normalizedEmail);
